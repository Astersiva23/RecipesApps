...
import Logo from '../images/Red_and_Blue.png'
    ...
    return (
        <header className='w-full fixed z-10 bg-black opacity-90'>
            <nav className='flex w-full py-2 md:py-3 px-4 md:px-20 items-center justify-between'>
                <a href="/" className='flex items-center justify-center text-white text-lg cursor-pointer gap-1'>
                    <img src={Logo} alt="Logo" className='hidden md:block w-12 h-12 lg:w-10 lg:h-10' />
                  <span className='text-red-600'>அஞ்சறைப்</span><span className='text-yellow-500'>பெட்டி</span>
                </a>
